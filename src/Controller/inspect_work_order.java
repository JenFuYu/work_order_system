...
public class inspect_work_order extends JFrame {

	private JPanel contentPane;
	public static inspect_work_order iwo_frame = null;
	 ...
	 * Create the frame.
	 */
	public inspect_work_order(int user_id,permission_set p1) {
		...
		contentPane.setLayout(null);
			...
			JLabel lblNewLabel = new JLabel("待驗收工單");
		...
		JButton assign_Button = new JButton("驗收工單");
		assign_Button.setBounds(654, 511, 120, 40);
		contentPane.add(assign_Button);
		
		/*
		前往inspect_work_order2
		*/
		assign_Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        inspect_work_order2.iwo2_frame = new inspect_work_order2(user_id,p1,wo2);
		        iwo_frame.setVisible(false);
				inspect_work_order2.iwo2_frame.setVisible(true);
        		dispose();
			}
		});
    ...
    protected void do_this_windowActivated(WindowEvent e) {
    	List<work_order> l1 = new implWork_order().select_uninspect();		//取得未指派資料
