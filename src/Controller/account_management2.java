...
public class account_management2 extends JFrame {

	private JPanel contentPane;
	public static account_management2 am2_frame = null;
	 ...
	 * Create the frame.
	 */
	public account_management2(int user_id,permission_set p1,users u2) {
		...
		JButton check_Button = new JButton("儲存變更");
		...
		ema_textField.setText(u2.getEmail());
		
		name_textField = new JTextField();
		name_textField.setColumns(10);
		name_textField.setBounds(86, 38, 167, 21);
		panel.add(name_textField);
		name_textField.setText(u2.getUser_name());
		
		eng_name_textField = new JTextField();
		eng_name_textField.setColumns(10);
		eng_name_textField.setBounds(86, 69, 167, 21);
		panel.add(eng_name_textField);
		eng_name_textField.setText(u2.getEnglish_name());
		
		gen_textField = new JTextField();
		gen_textField.setColumns(10);
		gen_textField.setBounds(86, 100, 167, 21);
		panel.add(gen_textField);
		gen_textField.setText(Integer.toString(u2.getGender()));
		
		bir_textField = new JTextField();
		bir_textField.setColumns(10);
		bir_textField.setBounds(86, 131, 167, 21);
		panel.add(bir_textField);
		bir_textField.setText(u2.getBirth_date());
		
		cel_textField = new JTextField();
		cel_textField.setColumns(10);
		cel_textField.setBounds(86, 162, 167, 21);
		panel.add(cel_textField);
		cel_textField.setText(u2.getCell_phone());
		
		JLabel lblNewLabel_2 = new JLabel("※1為男性，2為女性");
		lblNewLabel_2.setBounds(263, 103, 188, 15);
		...
		lblNewLabel_2_1.setBounds(263, 134, 188, 15);
