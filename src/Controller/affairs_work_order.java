...
public class affairs_work_order extends JFrame {

	private JPanel contentPane;
	public static affairs_work_order afwo_frame = null;
	 ...
	 * Create the frame.
	 */
	public affairs_work_order(int user_id,permission_set p1) {
		addWindowListener(new WindowAdapter() {
            @Override
            public void windowActivated(WindowEvent e) {
                do_this_windowActivated(e,user_id);
            }
        });
		...
		contentPane.setLayout(null);
			...
			JLabel lblNewLabel = new JLabel("待完成工單");
