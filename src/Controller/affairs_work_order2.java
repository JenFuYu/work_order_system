...
public class affairs_work_order2 extends JFrame {

	private JPanel contentPane;
	public static affairs_work_order2 afwo2_frame = null;
	 ...
	 * Create the frame.
	 */
	public affairs_work_order2(int user_id,permission_set p1,work_order wo) {
		...
		contentPane.setLayout(null);
			...
			JLabel lblNewLabel = new JLabel("完成工單");
		...
		JButton check_Button = new JButton("完成");
		...
		remark_textArea.setText((String) null);
		...
		general_show.setText(u1.getUser_name());
