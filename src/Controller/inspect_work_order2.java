...
public class inspect_work_order2 extends JFrame {

	private JPanel contentPane;
	public static inspect_work_order2 iwo2_frame = null;
	 ...
	 * Create the frame.
	 */
	public inspect_work_order2(int user_id,permission_set p1,work_order wo) {
		...
		contentPane.setLayout(null);
			...
			JLabel lblNewLabel = new JLabel("驗收工單");
		...
		JButton check_Button = new JButton("完成驗收");
		...
		inspect_show.setText(u1.getUser_name());
