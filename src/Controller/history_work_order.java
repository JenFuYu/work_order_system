...
public class history_work_order extends JFrame {

	private JPanel contentPane;
	public static history_work_order hwo_frame = null;
	 ...
	 * Create the frame.
	 */
	public history_work_order(int user_id,permission_set p1) {
		...
		search_textField.setBounds(140, 104, 268, 21);
		contentPane.add(search_textField);
		search_textField.setColumns(10);
		
		JButton search_Button = new JButton("New button");
		search_Button.setBounds(418, 102, 87, 23);
